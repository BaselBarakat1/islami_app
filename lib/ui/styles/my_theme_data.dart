...
class MyThemeData {
  ...
  static ThemeData lightTheme =ThemeData(
    ...
    textTheme: TextTheme(
      ...
      bodyLarge: TextStyle(fontSize: 25,fontWeight: FontWeight.w400,fontFamily: 'El Messiri',color: Colors.white) ,
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      bodyLarge: TextStyle(fontSize: 25,fontWeight: FontWeight.w400,fontFamily: 'El Messiri',color: darkPrimaryColor) ,
